...
namespace Wisonlau\IdentityCard;

/**
 * Class IdentityCard
 *
 * @link  https://wisonlau.com
 *
 * @author  wisonlau <122022066@qq.com>
 *
 * @package	Wisonlau\IdentityCard\IdentityCard
 *
 * @copyright  Copyright (c) 2017-2018, Wisonlau. All rights reserved.
 */
class IdentityCard
{
	/**
